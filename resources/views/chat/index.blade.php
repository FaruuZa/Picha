            ...
            <div class="ks-page-content-body">
                <div class="ks-messenger">
                    <div class="ks-discussions">
                        ...
                        <a data-toggle="modal" data-target="#logoutModal" style="color: white"><i
                            ...
                            <div class="ks-controls">
                                <div class="dropdown">
                                    <button class="btn btn-primary-outline ks-light ks-no-text ks-no-arrow" type="button"
                                        id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" data-display="static"
                                        aria-expanded="false">
                                        ...
                                        <form action="" method="GET">
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="search message" name="search"
                                                    aria-label="Recipient's username" aria-describedby="button-addon2" autocomplete="off" autofocus value="{{ $searched != '' ? $searched : '' }}">
                        ...
                        <div class="ks-body ks-scrollable jspScrollable" data-auto-height="" data-reduce-height=".ks-footer"
                            ...
                            <div class="jspContainer" style="width: 100%; height: auto;">
                                <div class="jspPane" style="padding: 0px; top: 0px; width: 100%;">
                                    <ul class="ks-items">
                                        @if ($searched)
                                            <a href="/" class="btn btn-outline-primary position-fixed" style="z-index:99;"><i class="fas fa-chevron-left"></i></a>
                                            <div class="mb-5"></div>
                                        @endif
                                        @if ($messages->count() == 0)
                                            <h3 class="disabled" style="text-align:center; width:100%; color:rgba(75, 75, 75, 0.877);">there is no message</h3>
                                        @endif
                                        @foreach ($messages as $message)
                                            <li
                                                class="ks-item {{ Auth::user()->name == $message->User->name ? 'ks-from' : 'ks-self' }}">
                                                <a href="" class="ks-avatar ks-online " data-toggle="modal"
